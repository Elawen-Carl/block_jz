  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="96px">
      ...
      <el-form-item label="关联业务编号" prop="relatedId">
        <el-input v-model="queryParams.relatedId" placeholder="请输入关联业务编号" clearable @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-dialog :title="title" v-model="open" width="700px" append-to-body>
      <el-form ref="blockchainRef" :model="form" :rules="rules" label-width="180px">
        <el-form-item label="关联业务编号" prop="relatedId">
